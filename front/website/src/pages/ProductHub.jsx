...
const fallbackSEO = {
  ...
  fa: {
    ...
    description: "خرید و بررسی قیمت انواع سنگ ساختمانی شامل تراورتن، مرمریت، گرانیت، چینی کریستال و مرمر برای اسلب، نما، کف و پله.",
    h1: "خرید و قیمت انواع سنگ ساختمانی",
    intro: "انواع سنگ طبیعی را بر اساس جنس، کاربرد، فرم عرضه و قیمت بررسی کنید. برای استعلام دقیق، نام سنگ، ابعاد، مقدار، فرآوری و شهر پروژه را ارسال کنید."
  },
  ar: {

...
export const catalogCopy = {
  en: {
    ...
    close: "Close", noImage: "No image", breadcrumb: "Breadcrumb", popularBadge: "Popular", offerLabel: "Offer", sampleRequestCta: "Request stone samples"
  },
  fa: {
    ...
    close: "بستن", noImage: "بدون تصویر", breadcrumb: "مسیر صفحه", popularBadge: "محبوب", offerLabel: "Offer", sampleRequestCta: "درخواست نمونه سنگ"
  },
  ar: {
    ...
    close: "إغلاق", noImage: "لا توجد صورة", breadcrumb: "مسار الصفحة", popularBadge: "شائع", offerLabel: "Offer", sampleRequestCta: "طلب عينات حجر"
  }
};
